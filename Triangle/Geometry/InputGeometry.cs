...
namespace TriangleNet.Geometry
{
    ...
    public class InputGeometry
    {
        ...
        public void AddPoint(double x, double y, double z, int boundary)
        {
            points.Add(new Vertex(x, y,z, boundary));
        ...
        public void AddPoint(double x, double y, double z, int boundary, double attribute)
        {
            AddPoint(x, y,z, 0, new double[] { attribute });
        }
        ...
        public void AddPoint(double x, double y,double z, int boundary, double[] attribs)
        {
            ...
            points.Add(new Vertex(x, y,z, boundary) { attributes = attribs });
        ...
        public void AddHole(double x, double y,double z)
        {
            holes.Add(new Point(x, y,z));
        }
        ...
        public void AddRegion(double x, double y,double z, int id)
        {
            regions.Add(new RegionPointer(x, y,z, id));
        }
