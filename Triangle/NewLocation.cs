...
namespace TriangleNet
{
    ...
    class NewLocation
    {
            ...
            ref double xi, ref double eta, bool offcenter, Otri badotri)
        {
            ...
            myCircumcenter = new Point(torg.x + dx, torg.y + dy, torg.z + dz);
            ...
            ref double xi, ref double eta, bool offcenter, Otri badotri)
        {
            ...
            double petal_slab_inter_x_first, petal_slab_inter_y_first, petal_slab_inter_z_first, petal_slab_inter_x_second, petal_slab_inter_y_second, x_1, y_1, x_2, y_2;
            double petal_bisector_x, petal_bisector_y, dist;
            double alpha;
            bool neighborNotFound_first;
            bool neighborNotFound_second;
            ////////////////////////////// END OF HALE'S VARIABLES //////////////////////////////
            petal_slab_inter_z_first = 0;
            Statistic.CircumcenterCount++;
                        ...
                        { // there is at least one intersection point
                            ...
                            if (Math.Abs(voronoiOrInter[0] - 1.0) <= EPS)
                            {
                                ...
                                lengthConst * ((smallestAngleCorner.x - line_inter_x) *
                                        ...
                                        && MinDistanceToNeighbor(petal_slab_inter_x_first, petal_slab_inter_y_first,petal_slab_inter_z_first, ref neighborotri) > MinDistanceToNeighbor(line_inter_x, line_inter_y, petal_slab_inter_z_first, ref neighborotri))
                                    {
                        ...
                        { // there is at least one intersection point				
                            ...
                            if (Math.Abs(voronoiOrInter[0] - 1.0) <= EPS)
                            {
                                ...
                                lengthConst * ((smallestAngleCorner.x - line_inter_x) *
                                        ...
                                        && MinDistanceToNeighbor(petal_slab_inter_x_second, petal_slab_inter_y_second, petal_slab_inter_z_first, ref neighborotri) > MinDistanceToNeighbor(line_inter_x, line_inter_y, petal_slab_inter_z_first, ref neighborotri))
                                    {
                                        // slab and petal intersection is advised
        ...
        /// <returns></returns>
        private double MinDistanceToNeighbor(double newlocX, double newlocY, double newlocZ, ref Otri searchtri)
        {
            ...
            Point newvertex = new Point(newlocX, newlocY, newlocZ);
