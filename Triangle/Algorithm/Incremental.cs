...
namespace TriangleNet.Algorithm
{
    ...
    class Incremental
    {
        ...
        void GetBoundingBox()
        {
            ...
            mesh.infvertex1 = new Vertex(box.Xmin - 50.0 * width, box.Ymin - 40.0 * width, box.Zmin);
            mesh.infvertex2 = new Vertex(box.Xmax + 50.0 * width, box.Ymin - 40.0 * width, box.Zmax);
            mesh.infvertex3 = new Vertex(0.5 * (box.Xmin + box.Xmax), box.Ymax + 60.0 * width, box.Zmax);
