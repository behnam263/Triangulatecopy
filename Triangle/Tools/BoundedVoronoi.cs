    ...
    public class BoundedVoronoi : IVoronoi
    {
        ...
        private void ConstructBoundaryBvdCell(Vertex vertex)
        {
            ...
            if (f_prev.triangle == Mesh.dummytri)
            {
                ...
                p = new Point(vertex.x, vertex.y,vertex.z);
                p.id = n + segIndex;
                points[n + segIndex] = p;
                segIndex++;
            ...
            torg = f.Org();
            tdest = f.Dest();
            p = new Point((torg.X + tdest.X) / 2, (torg.Y + tdest.Y) / 2, (torg.Z + tdest.Z) / 2);
            p.id = n + segIndex;
            points[n + segIndex] = p;
            segIndex++;
            ...
            do
            {
                ...
                if (f_next.triangle == Mesh.dummytri)
                {
                    ...
                    torg = f.Org();
                    tapex = f.Apex();
                    p = new Point((torg.X + tapex.X) / 2, (torg.Y + tapex.Y) / 2, (torg.Z + tapex.Z) / 2);
                    p.id = n + segIndex;
                    points[n + segIndex] = p;
                    segIndex++;
                ...
                else
                {
                    ...
                    if (!f_next.triangle.infected)
                    {
                        ...
                        Point bisec = new Point((tdest.X + tapex.X) / 2, (tdest.Y + tapex.Y) / 2, (tdest.Z + tapex.Z) / 2);
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            Point bisec = new Point((torg.X + tdest.X) / 2, (torg.Y + tdest.Y) / 2, (torg.Z + tdest.Z) / 2);
        ...
        private bool SegmentsIntersect(Point p1, Point p2, Point p3, Point p4, out Point p, bool strictIntersect)
        {
            ...
            p = new Point(Ax + ABpos * theCos, Ay + ABpos * theSin, Az + ABpos * theSin);
